...
const int TURN_SPEED = 100; // updated
...
void default_constants() {
  // P, I, D, and Start I
  // Base 20, 0, 100, 0
  chassis.pid_drive_constants_set(14.5, 0, 96.25, 10);         // Fwd/rev constants, used for odom and non odom motions
  // Base 11, 0, 20, 0
...
void worlds_qual() { // The Golden Ticket
  ...
  if (!IsGoalClamped){
    ...
    chassis.pid_drive_set(-4_in, 100, true);
    chassis.pid_wait();
  ...
  chassis.pid_drive_set(23_in, 80, true);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(-27_in, 30, true);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(19_in, 50, true);
  chassis.pid_wait();
